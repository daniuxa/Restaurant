...
namespace Restaurant.Dal.TypeConfigurations
{
    public class DishTypeConfiguration : IEntityTypeConfiguration<Dish>
    {
        ...
        {
            builder.HasData(
                    new Dish { PositionId = new Guid("06e0d7c2-9fbb-4c5e-b1cf-3951bba9316e"), Name = "Hamburger menu 1", TypeOfDish = "Burger", Price = 400, Weight = 350, PhotoLink = "https://ik.imagekit.io/Salivon/Menu/06e0d7c2-9fbb-4c5e-b1cf-3951bba9316e?updatedAt=1684869326662" },
                    new Dish { PositionId = new Guid("94ba0fbc-76ec-4eac-9b48-5ff5859da457"), Name = "Hamburger menu 2", TypeOfDish = "Burger", Price = 450, Weight = 400, PhotoLink = "https://ik.imagekit.io/Salivon/Menu/94ba0fbc-76ec-4eac-9b48-5ff5859da457?updatedAt=1684869350144" },
                    new Dish { PositionId = new Guid("860617fd-d341-41d2-a494-d982e8ae1f84"), Name = "Hamburger menu 3", TypeOfDish = "Burger", Price = 550, Weight = 450, PhotoLink = "https://ik.imagekit.io/Salivon/Menu/860617fd-d341-41d2-a494-d982e8ae1f84?updatedAt=1684869385003" },
                    new Dish { PositionId = new Guid("a680749e-8e43-4877-9fe4-cb7b3caf130d"), Name = "Hamburger menu 4", TypeOfDish = "Burger", Price = 500, Weight = 400, PhotoLink = "https://ik.imagekit.io/Salivon/Menu/a680749e-8e43-4877-9fe4-cb7b3caf130d?updatedAt=1684828898277" },
